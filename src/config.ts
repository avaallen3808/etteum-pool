...
export const config = {
  ...
  // Providers: kiro, kiro-pro, codebuddy, canva, codex, qoder, gitlab-duo, youmind, opencode, groq, openrouter, bai, cerebras, mistral, nvidia, uncloseai, chutes, gemini-web, deepseek-web, qwen-web, zai-web
  providers: ["kiro", "kiro-pro", "codebuddy", "canva", "codex", "qoder", "gitlab-duo", "youmind", "opencode", "groq", "openrouter", "bai", "cerebras", "mistral", "nvidia", "uncloseai", "chutes", "gemini-web", "deepseek-web", "qwen-web", "zai-web"] as const,
} as const;
