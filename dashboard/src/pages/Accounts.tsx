  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-2 text-xs">
        <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/10 px-2.5 py-1 text-emerald-700 border border-emerald-500/20"><span className="h-2 w-2 rounded-full bg-emerald-500" /> Free API (9) — Opencode, Groq, OpenRouter, B.AI, Cerebras, Mistral, Nvidia, UncloseAI, Chutes</span>
        <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-500/10 px-2.5 py-1 text-blue-700 border border-blue-500/20"><span className="h-2 w-2 rounded-full bg-blue-500" /> Web Cookie (5) — Gemini, DeepSeek, Qwen, Z.AI, Canva</span>
        <span className="inline-flex items-center gap-1.5 rounded-full bg-zinc-500/10 px-2.5 py-1 text-zinc-700 border border-zinc-500/20"><span className="h-2 w-2 rounded-full bg-zinc-400" /> Other (8) — Kiro, CodeBuddy, Codex, Qoder, GitLab Duo, YouMind</span>
        <a href="/bookmarklet.html" target="_blank" rel="noreferrer" className="ml-auto text-[var(--primary)] hover:underline">🔖 1-Click Cookie Exporter →</a>
      </div>
